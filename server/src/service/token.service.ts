...
import { ACCESS_TOKEN_TYPE, RESET_PASSWORD_TOKEN_TYPE, REFRESH_TOKEN_TYPE } from "../constant";
   ...
   tokenVerify: ( token: string, type: string ) => {
      ...
      switch ( type ) {
         ...
         case REFRESH_TOKEN_TYPE:
            ...
            break;
         case RESET_PASSWORD_TOKEN_TYPE:
            secretKey = config.SECRET_RESET_PASS_KEY;
            break;
      }
